   ...
   <div className="bg-gray-100 ">
      <div className="container mx-auto">
        <div className="">
          ...
          <p className="text-base text-center font-normal mt-4 text-gray-400">
        ...
        <div className="card bg-base-100 md:mx-48 mt-7 shadow">
          <div className="card-body text-center">
            ...
            <div className="card-actions justify-center">
              <Link to={'/DonationCampaigns'} className="btn btn-wide text- bg-orange-300">Donate Now</Link>
            </div>
          </div>
        </div>
